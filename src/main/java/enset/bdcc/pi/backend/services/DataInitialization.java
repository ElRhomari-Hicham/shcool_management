...
public class DataInitialization {
    ...
    public void initData() {
        ...
        if (rooms.size() == 0) {
            ...
            Etudiant user = new Etudiant("DB137546", "Yassine", "Faiq", "1525486868788", "homme", LocalDate.of(1997, 5, 20), "Laayoune", "yassine.faiq@gmail.com", "simp");//new Etudiant("JK77777","Yassir","BOURAS");
