...
public class BackendApplication implements CommandLineRunner {
    ...
    public void preloadDiplomes() {
        diplomeList.add(new Diplome("cycle_ing", "Cycle Ingénieur", 3));
    ...
    public void preloadSession() {
        Session session = new Session(2020, filiereList.get(1));
        List<SemestreFiliere> semestreFiliereList = new ArrayList<>(filiereList.get(1).getSemestreFilieres());
